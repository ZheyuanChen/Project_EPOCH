...
def main():
    parser = argparse.ArgumentParser(description="Interactive viewer for EPOCH spectra subdirectories.")
    parser.add_argument('--dir', required=True, help="Parent directory containing the spectra subfolders")
    ...
    ax.set_title(f"Folder: {group_names[current_group_idx]} | Frame: {current_frame_idx}", fontsize=14, pad=10)
