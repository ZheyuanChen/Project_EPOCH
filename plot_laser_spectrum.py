...
def main():
    parser = argparse.ArgumentParser(description="Plot Laser Intensity and Frequency Spectrum.")
    parser.add_argument('--dir', dest='input_dir', required=True, help="Input directory containing .sdf files")
